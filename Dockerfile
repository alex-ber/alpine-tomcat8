...
ARG TOMCAT_VERSION_ARG=8.5.24
ARG TOMCAT_MAJOR_VERSION_ARG=8
ARG TOMCAT_NATIVE_VERSION_ARG=1.2.17

ENV TOMCAT_MAJOR_VERSION=$TOMCAT_MAJOR_VERSION_ARG
ENV TOMCAT_VERSION=$TOMCAT_VERSION_ARG
ENV TOMCAT_NATIVE_VERSION=$TOMCAT_NATIVE_VERSION_ARG
...
#ENV setenv.sh
ENV TOMCAT_SERVER_XMS=
ENV TOMCAT_SERVER_NEW_SIZE=
ENV TOMCAT_SERVER_MAX_NEW_SIZE=
ENV TOMCAT_SERVER_USERNAME=
ENV TOMCAT_SERVER_PASSWORD=
